...
from backend.schemas.dashboard_metrics_schema import (
    Dashboard_metricsCreate,
    Dashboard_metricsSchema,
    Dashboard_metricsUpdate,
)
...
async def get_dashboard_metrics():
    ...
    try:
        ...
        alertas_criticos = await db["alertas"].count_documents(
            {
